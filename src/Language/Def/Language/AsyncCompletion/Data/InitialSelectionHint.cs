...
namespace Microsoft.VisualStudio.Language.Intellisense.AsyncCompletion.Data
{
    ...
    public enum InitialSelectionHint
    {
        ...
        /// Completion UI will initially not appear.
        /// Pressing Tab will dismiss the invisible session.
        /// This option is used only in narrow corner cases.
        /// When multiple <see cref="IAsyncCompletionSource"/> give different results, this value has the highest priority.
        /// </summary>
        NoSelection
    }
}
